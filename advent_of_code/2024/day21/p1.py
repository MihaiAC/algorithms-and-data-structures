...
class Solution:
    def __init__(self, input_file: str):
        ...
        self.NUMPAD_SHORTEST_COMBOS = self.precompute_shortest_combos(
            self.NUMPAD, self.NUMPAD_AVOID
        )
        self.DIRECTIONAL_SHORTEST_COMBOS = self.precompute_shortest_combos(
    ...
    def precompute_shortest_combos(
    ...
    def code_to_minimal_length_combos(
        self,
        combo_schema: Dict[Tuple[str, str], List[str]],
    ...
    def get_final_combos(self, code: str) -> List[str]:
        first_robot_codes = self.code_to_minimal_length_combos(
            self.NUMPAD_SHORTEST_COMBOS, [code]
        )
        second_robot_codes = self.code_to_minimal_length_combos(
            self.DIRECTIONAL_SHORTEST_COMBOS, first_robot_codes
        )
        third_codes = self.code_to_minimal_length_combos(
            self.DIRECTIONAL_SHORTEST_COMBOS, second_robot_codes
        )
        return third_codes
